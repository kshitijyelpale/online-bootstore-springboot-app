...
public class BookController {
    ...
    public ResponseEntity<?> saveBook(@RequestBody Book book) {
        ...
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(BookController.class).findBookById(savedBook.getId())).withSelfRel());
    ...
    public ResponseEntity<?> updateQuantity(@PathVariable("id") Long bookId, @PathVariable("value") Integer value) {
        ...
        resource.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(BookController.class).findBookById(book.getId())).withSelfRel());

        return new ResponseEntity<>(resource, HttpStatus.OK);
    }

    @GetMapping("/{id}")
    public ResponseEntity<?> findBookById(@RequestParam("id") Long bookId) {
